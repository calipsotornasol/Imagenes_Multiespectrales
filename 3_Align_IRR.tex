...
\makeatother
    ...
    This code uses the Python Open CV library to align near infrarred and
red band images in the format tif and combines them to produce an
aligned image in the format JPG. In addition, this code transfers the
GPS information from the image in the reference band to the aligned RGB
image.

Extensions asociated to each name file refers to a diferente band as is
detailed below '*\_1.tif' = Blue Band '*\_2.tif' = Green Band '*\_3.tif'
= Red Band '*\_4.tif' = Near Infrarred Band '*\_5.tif' = Rededge Band

The output can be used to compute the NDVI vegetation index.

Unfourtunatly , the code does not align the images properly, so it needs
to be improved.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}Preamble}
...
2018-06-10 23:11:09.545761
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}Setting directory}
         \PY{n}{dir\PYZus{}set}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/tidchile/collaborative/udd/ids/agro/AGRIFRUT\PYZus{}10\PYZhy{}02/MICASENSE/0000SET/000}\PY{l+s+s1}{\PYZsq{}}
         ...
         \PY{c+c1}{\PYZsh{}\PYZsh{}Listing blue images}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}Listing red images}
         \PY{n}{filenamesRED}\PY{o}{=}\PY{p}{[}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}Listing near infrarred images}
         \PY{n}{filenamesIR}\PY{o}{=}\PY{p}{[}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}Listing rededge images}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}Creating folder to save aligned images}
         \PY{k}{if} \PY{o+ow}{not} \PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{exists}\PY{p}{(}\PY{n}{dir\PYZus{}set}\PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZus{}IRR\PYZus{}ALIGNED/}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
             \PY{n}{os}\PY{o}{.}\PY{n}{makedirs}\PY{p}{(}\PY{n}{dir\PYZus{}set}\PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZus{}IRR\PYZus{}ALIGNED/}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{} Define motion model}
         \PY{n}{warp\PYZus{}mode} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{MOTION\PYZus{}EUCLIDEAN} \PY{c+c1}{\PYZsh{}(Options:MOTION\PYZus{}TRANSLATION, MOTION\PYZus{}EUCLIDEAN, MOTION\PYZus{}AFFINE and MOTION\PYZus{}HOMOGRAPHY)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} Set the stopping criteria for the algorithm.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{n}{dir\PYZus{}irr}\PY{o}{=}\PY{n}{dir\PYZus{}set}\PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZus{}IRR\PYZus{}ALIGNED/}\PY{l+s+s1}{\PYZsq{}}
         
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{dir\PYZus{}irr}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
/tidchile/collaborative/udd/ids/agro/AGRIFRUT\_10-02/MICASENSE/0000SET/000\_IRR\_ALIGNED/

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}Aligning images and saving as .JPG}
         \PY{c+c1}{\PYZsh{}Creating log file. List images which were not aligned}
         
         \PY{n}{log} \PY{o}{=} \PY{n+nb}{open}\PY{p}{(}\PY{n}{dir\PYZus{}irr} \PY{o}{+} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{error\PYZus{}align.log}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{w}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{filenamesRED}\PY{p}{)}\PY{p}{)}\PY{p}{:}
             \PY{k}{try}\PY{p}{:}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Processing: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n}{filenamesRED}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{74}\PY{p}{:}\PY{l+m+mi}{82}\PY{p}{]}\PY{p}{)}
                 ...
                 \PY{n}{sz} \PY{o}{=} \PY{n}{im\PYZus{}red}\PY{o}{.}\PY{n}{shape}
                 ...
                 \PY{c+c1}{\PYZsh{}Red}
                 \PY{p}{(}\PY{n}{cc}\PY{p}{,} \PY{n}{warp\PYZus{}matrix}\PY{p}{)} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{findTransformECC} \PY{p}{(}\PY{n}{im\PYZus{}redge}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{,} \PY{n}{im\PYZus{}red}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{,}\PY{n}{warp\PYZus{}matrix}\PY{p}{,} \PY{n}{warp\PYZus{}mode}\PY{p}{,} \PY{n}{criteria}\PY{p}{)}
             
                 \PY{n}{im\PYZus{}aligned}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{]} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{warpAffine}\PY{p}{(}\PY{n}{im\PYZus{}red}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{,} \PY{n}{warp\PYZus{}matrix}\PY{p}{,} \PY{p}{(}\PY{n}{width}\PY{p}{,} \PY{n}{height}\PY{p}{)}\PY{p}{,} \PY{n}{flags}\PY{o}{=}\PY{n}{cv2}\PY{o}{.}\PY{n}{INTER\PYZus{}LINEAR} \PY{o}{+} \PY{n}{cv2}\PY{o}{.}\PY{n}{WARP\PYZus{}INVERSE\PYZus{}MAP}\PY{p}{)}\PY{p}{;}
                 ...
                 \PY{n}{im\PYZus{}aligned}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{=} \PY{n}{cv2}\PY{o}{.}\PY{n}{warpAffine}\PY{p}{(}\PY{n}{im\PYZus{}ir}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{p}{,} \PY{n}{warp\PYZus{}matrix}\PY{p}{,} \PY{p}{(}\PY{n}{width}\PY{p}{,} \PY{n}{height}\PY{p}{)}\PY{p}{,} \PY{n}{flags}\PY{o}{=}\PY{n}{cv2}\PY{o}{.}\PY{n}{INTER\PYZus{}LINEAR} \PY{o}{+} \PY{n}{cv2}\PY{o}{.}\PY{n}{WARP\PYZus{}INVERSE\PYZus{}MAP}\PY{p}{)}\PY{p}{;}
                 \PY{n}{cv2}\PY{o}{.}\PY{n}{imwrite}\PY{p}{(}\PY{n}{dir\PYZus{}irr} \PY{o}{+} \PY{n}{filenamesRED}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{74}\PY{p}{:}\PY{l+m+mi}{82}\PY{p}{]}\PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZus{}IRR.JPG}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{im\PYZus{}aligned}\PY{p}{)}
             \PY{k}{except} \PY{n+ne}{Exception}\PY{p}{:} 
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Error processing: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n}{filenamesRED}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{74}\PY{p}{:}\PY{l+m+mi}{82}\PY{p}{]}\PY{p}{)}
                 \PY{n}{log}\PY{o}{.}\PY{n}{write}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Error processing: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n}{filenamesRED}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{74}\PY{p}{:}\PY{l+m+mi}{82}\PY{p}{]} \PY{o}{+} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 \PY{k}{continue}
\end{Verbatim}
...
(960, 1280)
Error processing: IMG\_0008
Processing: IMG\_0009
(960, 1280)
Error processing: IMG\_0009
Processing: IMG\_0010
(960, 1280)
Error processing: IMG\_0010
...
(960, 1280)
Error processing: IMG\_0013
Processing: IMG\_0014
(960, 1280)
Error processing: IMG\_0014
Processing: IMG\_0015
(960, 1280)
Error processing: IMG\_0015
Processing: IMG\_0016
(960, 1280)
Error processing: IMG\_0016
Processing: IMG\_0017
(960, 1280)
Error processing: IMG\_0017
Processing: IMG\_0018
(960, 1280)
Error processing: IMG\_0018
Processing: IMG\_0019
(960, 1280)
Error processing: IMG\_0019
Processing: IMG\_0020
(960, 1280)
Error processing: IMG\_0020
Processing: IMG\_0021
(960, 1280)
Error processing: IMG\_0021
Processing: IMG\_0022
(960, 1280)
Error processing: IMG\_0022
Processing: IMG\_0023
(960, 1280)
Error processing: IMG\_0023
Processing: IMG\_0024
(960, 1280)
Error processing: IMG\_0024
Processing: IMG\_0025
(960, 1280)
Error processing: IMG\_0025
Processing: IMG\_0026
(960, 1280)
Error processing: IMG\_0026
Processing: IMG\_0027
(960, 1280)
Error processing: IMG\_0027
Processing: IMG\_0028
(960, 1280)
Error processing: IMG\_0028
Processing: IMG\_0029
(960, 1280)
Error processing: IMG\_0029
Processing: IMG\_0030
(960, 1280)
Error processing: IMG\_0030
Processing: IMG\_0031
(960, 1280)
Error processing: IMG\_0031
Processing: IMG\_0032
(960, 1280)
Error processing: IMG\_0032
Processing: IMG\_0033
(960, 1280)
Error processing: IMG\_0033
